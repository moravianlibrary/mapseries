...
module.exports = function() {
  ...
  var texts = {
    'sk': {
      ...
      newSerieDialogSerieGrid: 'Názov kladu, do ktorej séria spadá',
      other: 'Iná',
      ...
      clearColumn: 'Vymazať dáta zo stĺpca',
	...
	'cs': {
      ...
      newSerieDialogSerieGrid: 'Název kladu, do které série spadá',
      other: 'Jiná',
      ...
      clearColumn: 'Vymazat data ze sloupce',
    ...
    'en': {
      ...
      newSerieDialogSerieGrid: 'Name of grid to which serie belongs',
      other: 'Other',
      saveFailed: 'Saving failed. Unexpected error occured',
      saveSuccess: 'Saved successfully',
      discardFailed: 'Discard failed. Unexpected error occured',
      discardSuccess: 'Changes were successfully discarded',
